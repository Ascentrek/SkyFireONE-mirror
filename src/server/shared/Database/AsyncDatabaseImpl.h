...
DatabaseWorkerPool::AsyncQuery(Class *object, void (Class::*method)(QueryResult_AutoPtr), const char *sql)
{
    ...
    SQLQueryTask* task = new SQLQueryTask(sql, new Skyfire::QueryCallback<Class>(object, method), itr->second);
    Enqueue(task);
    return true;
}
...
{
    ASYNC_QUERY_BODY(sql, itr)
    SQLQueryTask* task = new SQLQueryTask(sql, new Skyfire::QueryCallback<Class, ParamType1>(object, method, (QueryResult_AutoPtr)NULL, param1), itr->second);
    Enqueue(task);
    return true;
}
...
{
    ASYNC_QUERY_BODY(sql, itr)
    SQLQueryTask* task = new SQLQueryTask(sql, new Skyfire::QueryCallback<Class, ParamType1, ParamType2>(object, method, (QueryResult_AutoPtr)NULL, param1, param2), itr->second);
    Enqueue(task);
    return true;
}
...
{
    ASYNC_QUERY_BODY(sql, itr)
    SQLQueryTask* task = new SQLQueryTask(sql, new Skyfire::QueryCallback<Class, ParamType1, ParamType2, ParamType3>(object, method, (QueryResult_AutoPtr)NULL, param1, param2, param3), itr->second);
    Enqueue(task);
    return true;
}
...
{
    ASYNC_QUERY_BODY(sql, itr)
    SQLQueryTask* task = new SQLQueryTask(sql, new Skyfire::SQueryCallback<ParamType1>(method, (QueryResult_AutoPtr)NULL, param1), itr->second);
    Enqueue(task);
    return true;
}
...
{
    ASYNC_QUERY_BODY(sql, itr)
    SQLQueryTask* task = new SQLQueryTask(sql, new Skyfire::SQueryCallback<ParamType1, ParamType2>(method, (QueryResult_AutoPtr)NULL, param1, param2), itr->second);
    Enqueue(task);
    return true;
}
...
{
    ASYNC_QUERY_BODY(sql, itr)
    SQLQueryTask* task = new SQLQueryTask(sql, new Skyfire::SQueryCallback<ParamType1, ParamType2, ParamType3>(method, (QueryResult_AutoPtr)NULL, param1, param2, param3), itr->second);
    Enqueue(task);
    return true;
}
...
DatabaseWorkerPool::DelayQueryHolder(Class *object, void (Class::*method)(QueryResult_AutoPtr, SQLQueryHolder*), SQLQueryHolder *holder)
{
    ...
    SQLQueryHolderTask *task = new SQLQueryHolderTask(holder, new Skyfire::QueryCallback<Class, SQLQueryHolder*>(object, method, (QueryResult_AutoPtr)NULL, holder),  itr->second);
    Enqueue(task);
    return true;
}
...
{
    ASYNC_DELAYHOLDER_BODY(holder, itr)
    SQLQueryHolderTask *task = new SQLQueryHolderTask(holder, new Skyfire::QueryCallback<Class, SQLQueryHolder*, ParamType1>(object, method, (QueryResult_AutoPtr)NULL, holder, param1),  itr->second);
    Enqueue(task);
    return true;
}
